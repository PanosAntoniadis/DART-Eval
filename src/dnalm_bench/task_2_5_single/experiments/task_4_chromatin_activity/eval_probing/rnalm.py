...
if __name__ == "__main__":
    ...
    model_dir = os.path.join(root_output_dir, f"task_4_chromatin_activity/supervised_models/probed/{model_name}_{seed}/{cell_line}/v1")
    ...
    out_dir = os.path.join(root_output_dir, f"task_4_chromatin_activity/supervised_model_outputs/probed/{model_name}_{seed}/{cell_line}/") 
